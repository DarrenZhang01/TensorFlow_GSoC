...
I temporarily put this file under the same repo as stax since the TF 2.3 nightly
version has not been integrated into standard TF API. It will be removed once
it is possible to call stateless operations in this file using TF API.
"""
